...
router.post('/auth/soumissionnaires', async (req, res) => {
...
router.post('/auth/soumissionnaires/login', async (req, res) => {
    try {
...
router.post('/auth/soumissionnaires/logout', auth(Soumissionnaire), async (req, res) => {
    try {
...
//Update password
router.patch('/auth/soumissionnaires/password/:id', auth(Soumissionnaire), async (req, res) => {
...
router.patch('/auth/soumissionnaires/modify/:id', auth(Soumissionnaire), async(req, res) => {
    const _id = req.params.id
...
router.post('/auth/soumissionnaires/me/image', auth(Soumissionnaire), upload.single('image'), async (req, res) => {
    const file = req.file
...
router.get('/auth/soumissionnaires/image/:id', async (req, res) => {
    try {
...
router.delete('/auth/soumissionnaires/me/image', auth(Soumissionnaire), async (req, res) => {
    try {
...
router.delete('/auth/soumissionnaires/:id'/*, auth(Soumissionnaire)*/, async(req, res) => {
    const _id = req.params.id
    try {
...
router.patch('/auth/soumissionnaires/forgotPassword/:email', async(req,res) => {
...
router.patch('/auth/soumissionnaires/verification/:email', async(req,res) => {
    try {
        const soumissionnaire = await Soumissionnaire.findOne({email: req.params.email})
...
router.get('/auth/soumissionnaires/:id', async (req, res) => {
    try {
        const soumissionnaire = await Soumissionnaire.findById(req.params.id)
...
router.get('/auth/soumissionnaires/search/:lastname', async (req, res) => {
...
router.get('/auth/soumissionnaires', async (req, res) => {
    try {
